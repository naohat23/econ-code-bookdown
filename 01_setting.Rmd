...
Rを使用する際の各種設定です。パッケージのインストール・インポートや、プロキシサーバーの設定（プロキシ環境のみ）など、Rの使用に欠かせない様々な設定について記載しています。
...
packages <- c(
  ...
  "esquisse", "geofacet", "ggplotgui", "ggpubr", "ggsci", "ggrepel", "lemon", "RColorBrewer",
