...
そうしたSSLエラーが生じた場合は、次のコマンドを実行することでエラーが解消する可能性があります。詳細は[Rのディベロッパー用ウェブサイトにおける2022年8月6日のニュース](https://developer.r-project.org/blosxom.cgi/R-4-2-branch/NEWS/2022/08/06#n2022-08-06)を参照してください。
...
-   データパッケージ
    -   [fpp](https://cran.r-project.org/web/packages/fpp/index.html)：様々なサンプルデータセットを格納したパッケージ
