...
-   統計系
    ...
    -   [fpp2](https://otexts.com/fpp2/)：時系列データ予測テキスト用に開発されたパッケージ
...
packages <- c(
  ...
  "corrplot", "corrr", "DataExplorer", "fpp2", "GGally", "mgcv", "plm", "psych", "seasonal", "seasonalview", "sigmoid", "SmartEDA", "tidyquant",
  "openxlsx", "pbapply"
)
