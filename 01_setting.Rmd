...
-   統計系
    -   [corrplot](https://cran.r-project.org/web/packages/corrplot/vignettes/corrplot-intro.html)：相関係数行列を計算・可視化
    -   [corrr](https://corrr.tidymodels.org/)：相関係数行列を計算・可視化
...
packages <- c(
  ...
  "corrplot", "corrr", "mgcv", "plm", "psych", "sigmoid", "tidyquant",
  "openxlsx"
)
