...
packages <- c(
  ...
  # 図表系
  "esquisse", "geofacet", "ggfortify", "ggplotgui", "ggpubr", "ggsci", "ggrepel", "hexbin", "lemon", "RColorBrewer",
  # 統計系
  "corrplot", "corrr", "DataExplorer", "estimatr", "forecast", "fpp2", "GGally", "lmtest", "mFilter", "mgcv", "plm", "psych", "sandwich", "seasonal", "sigmoid", "SmartEDA", "strucchange", "tidyquant", "tseries", "vars", "urca",
  # データパッケージ
  "nycflights13",
  # その他
  "openxlsx", "pbapply"
