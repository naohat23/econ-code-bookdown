...
&+ \frac{E_t\alpha_{t}N_{t}\Delta{\alpha_t}\Delta{N_t} + \alpha_{t-1}N_{t-1}\Delta{E_t}\Delta{(\alpha_tN_t)}-E_{t-1}(\Delta{(\alpha_tN_t)})^2}{\alpha^2_{t-1}N^2    _{t-1}\alpha_{t}N_{t}}
\end{align}
$$
